 ...
 * @Date: Create on 2018-04-17 17:18.
 * @Describution:
 *         decide 方法是判定是否拥有权限的决策方法，
 *         authentication 是 GrantedAuthority 对象中的权限信息集合.
 *         object o 包含客户端发起的请求的requset信息，可转换为 HttpServletRequest request = ((FilterInvocation)
 *         object).getHttpRequest();
 *         configAttributes 为MyInvocationSecurityMetadataSource的getAttributes(Object object)
 *    这个方法返回的结果，此方法是为了判定用户请求的url 是否在权限表中，如果在权限表中，则返回给 decide 方法，用来判定用户是否有此权限。如果不在权限表中则放行。
 *
 */
@Service
public class MyAccessDecisionManager implements AccessDecisionManager {
    ...
    public void decide(Authentication authentication, Object o, Collection<ConfigAttribute> collection) throws AccessDeniedException, InsufficientAuthenticationException {
        ...
        throw new ParamException(ResultEnum.NOT_ALLOWED);
    }
