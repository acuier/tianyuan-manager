package tianyuan.common.PluginBeans;

import org.apache.commons.collections.CollectionUtils;
import org.apache.commons.lang3.StringUtils;
import org.springframework.data.domain.Sort;
import org.springframework.data.jpa.domain.Specification;
import tianyuan.common.enums.OperatorSpecification;
 ...
 * @Date: Create on 2018-04-10 16:43.
 * @Describution:复杂查询的条件封装(单表)
 */

public class TySpecification<T> implements Specification {
    ...
    public Predicate toPredicate(Root root, CriteriaQuery criteriaQuery, CriteriaBuilder criteriaBuilder) {
        ...
        restrictions = criteriaBuilder.and(restrictions, getOrPredicates(root, criteriaBuilder));
        criteriaQuery.orderBy(getOrders(root, criteriaBuilder));
        return restrictions;
    }


    public TySpecification and(Collection<Cnd> conditions) {
        andConditions.addAll(conditions);
        return this;
    }
    public TySpecification and(Cnd... conditions) {
        for (Cnd condition : conditions) {
            andConditions.add(condition);
        }
        return this;
    }
    public TySpecification or(Collection<Cnd> conditions) {
        orConditions.addAll(conditions);
        return this;
    }
    public TySpecification or(Cnd... conditions) {
        for (Cnd condition : conditions) {
            orConditions.add(condition);
        }
        return this;
    }
    public TySpecification desc(String property) {
        this.orders.add(Order.desc(property));
        return this;
    }
    public TySpecification asc(String property) {
        this.orders.add(Order.asc(property));
        return this;
    }
    public TySpecification order(String property, Sort.Direction direction) {
        this.orders.add(new Order(property, direction));
        return this;
    }
    public TySpecification orders(Order... orders) {
        this.orders.addAll(Arrays.asList(orders));
        return this;
    }
    public TySpecification orders(Collection<Order> orders) {
    ...
    public static class Cnd {
        ...
        String property;
        Object value;
        public Cnd(String property, OperatorSpecification operator, Object value) {
            this.operator = operator;
            this.property = property;
            this.value = value;
        }
        public Cnd(String property, OperatorSpecification operator) {
            this.operator = operator;
            this.property = property;
        }
        /**
        ...
        public static Cnd eq(String property, Object value) {
            return new Cnd(property, OperatorSpecification.eq, value);
        }
        /**
         * 不相等
         *
        ...
        public static Cnd ne(String property, Object value) {
            return new Cnd(property, OperatorSpecification.ne, value);
        }
        /**
         * 大于
         *
        ...
        public static Cnd gt(String property, Object value) {
            return new Cnd(property, OperatorSpecification.gt, value);
        }
        /**
         * 小于
         *
        ...
        public static Cnd lt(String property, Object value) {
            return new Cnd(property, OperatorSpecification.lt, value);
        }
        /**
         * 大于等于
         *
        ...
        public static Cnd ge(String property, Object value) {
            return new Cnd(property, OperatorSpecification.ge, value);
        }
        /**
         * 小于等于
         *
        ...
        public static Cnd le(String property, Object value) {
            return new Cnd(property, OperatorSpecification.le, value);
        }
        /**
         * 模糊like %%
         *
        ...
        public static Cnd like(String property, Object value) {
            return new Cnd(property, OperatorSpecification.like, value);
        }
        /**
         * 模块右like xxx%
         *
        ...
        public static Cnd rlike(String property, Object value) {
            return new Cnd(property, OperatorSpecification.rlike, value);
        }
        /**
         * 模糊左like %xxx
         *
        ...
        public static Cnd llike(String property, Object value) {
            return new Cnd(property, OperatorSpecification.llike, value);
        }
        /**
         * 自定义模糊
         *
        ...
        public static Cnd ilike(String property, Object value) {
            return new Cnd(property, OperatorSpecification.ilike, value);
        }
        /**
         * 集合中
         *
        ...
        public static Cnd in(String property, Object value) {
            return new Cnd(property, OperatorSpecification.in, value);
        }
        /**
         * 不在集合中
         *
        ...
        public static Cnd notIn(String property, Object value) {
            return new Cnd(property, OperatorSpecification.notIn, value);
        }
        /**
         * 是空
         *
        ...
        public static Cnd isNull(String property) {
            return new Cnd(property, OperatorSpecification.isNull);
        }
        /**
         * 不是空
         *
        ...
        public static Cnd isNotNull(String property) {
            return new Cnd(property, OperatorSpecification.isNotNull);
        }
    }
    /**
     * 排序
